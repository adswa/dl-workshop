...
- :house: **Where?** Virtual (links to video-conference system will be provided via e-mail). Please register with [Tobias Sommer (t.sommer@uke.de))](mailto:t.sommer@uke.de) and fill out a short registration form online) (see [registration ](#logistics))
...
<a href="https://www.socialsciencespace.com/wp-content/uploads/625px-To_deposit_or_not_to_deposit_that_is_the_question_-_journal.pbio_.1001779.g001.png" target="_blank">
<img src="img/datasharing.png" alt="A metaphor for papers and project directories" width="650"/></a>
...
:arrow_right: **To register for the workshop, please reach out to Tobias Sommer ([t.sommer@uke.de)](mailto:t.sommer@uke.de))**. Please also answer a short survey to help us to tune the workshop for your interests, skills, and experiences [here](https://forms.gle/DhnXLGctgstabtwm6).
